...
//             className="bg-blue-600 text-white py-1 text-md font-semibold  rounded-lg hover:bg-blue-800 text-center"
//           >
//             Play Trailer
//           </a>
//         </div>
...
//           favorites.includes(movie.id) ? "text-yellow-300" : "text-gray-400"
//         }`}
//       >
